                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#services">Account Management</a></li>
                            <li class="scroll-to-section"><a href="#frequently-question">QR Integration</a></li>
                            <li class="scroll-to-section"><a href="#contact-us">Record Management</a></li>
